  ...
  <div id="container">
    ...
    <main>
      ...
      <div class="add-vehicle-div">
          <a href="?action=addvehicle">
            <div class="add-vehicle-btn btn">Add Vehicle</div>
          </a>
        </div>
        <div class="add-classification-div">
          <a href="?action=add-classification">
            <div class="add-classification-btn btn">Add Classification</div>
          </a>
        </div>
    </main>
    <footer>
